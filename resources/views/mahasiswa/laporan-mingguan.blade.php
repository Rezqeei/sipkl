<x-mahasiswa-layout>
    <div class="space-y-8 p-6 md:p-10">
        ...
        <div class="bg-white p-6 md:p-8 rounded-xl shadow-lg border">
            ...
            <form method="POST" action="{{ route('mahasiswa.laporan.mingguan.store') }}" enctype="multipart/form-data" class="space-y-4 max-w-lg mx-auto">
                @csrf
                <div>
                    <label for="minggu_ke" class="block font-medium">Minggu Ke</label>
                    <input type="number" name="minggu_ke" id="minggu_ke" class="w-full mt-1 p-2 border rounded-lg" min="1" required>
                </div>
                <div>
                ...
                <div class="text-center pt-2">
                    <button type="submit" class="bg-blue-600 text-white font-semibold py-2 px-6 rounded-lg">Unggah</button>
                </div>
            </form>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="py-4 px-4 text-center text-gray-500">Belum ada laporan yang diunggah.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
