            ...
            <form method="POST" action="{{ route('mahasiswa.pengajuan.store') }}" class="space-y-6 max-w-2xl mx-auto">
                ...
                <div>
                    ...
                    <input type="text" name="nama_lengkap" id="nama_lengkap" placeholder="Masukkan nama lengkap Anda"
                        ...
                        class="w-full px-4 py-3 border rounded-lg shadow-sm @error('nama_lengkap') border-red-500 @enderror"
                        required>
                    @error('nama_lengkap')
                ...
                <div>
                    ...
                    <input type="text" name="nim" id="nim" placeholder="Masukkan NIM Anda" value="{{ old('nim') }}"
                        class="w-full px-4 py-3 border rounded-lg shadow-sm @error('nim') border-red-500 @enderror"
                        required>
                    @error('nim')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" name="jurusan" id="jurusan" placeholder="Masukkan jurusan Anda"
                        value="{{ old('jurusan') }}"
                        class="w-full px-4 py-3 border rounded-lg shadow-sm @error('jurusan') border-red-500 @enderror"
                        required>
                    @error('jurusan')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" name="nama_kampus" id="nama_kampus" placeholder="Masukkan nama kampus Anda"
                        ...
                        class="w-full px-4 py-3 border rounded-lg shadow-sm @error('nama_kampus') border-red-500 @enderror"
                        required>
                    @error('nama_kampus')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <textarea name="alamat" id="alamat" rows="3" placeholder="Masukkan alamat lengkap Anda"
                        class="w-full px-4 py-3 border rounded-lg shadow-sm @error('alamat') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input type="date" name="tgl_mulai" id="tgl_mulai" value="{{ old('tgl_mulai') }}"
                        class="w-full px-4 py-3 border rounded-lg shadow-sm @error('tgl_mulai') border-red-500 @enderror"
                        required>
                    @error('tgl_mulai')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    <label for="tgl_berakhir" class="block mb-1 text-sm font-medium text-gray-600">Tanggal
                        Berakhir</label>
                    <input type="date" name="tgl_berakhir" id="tgl_berakhir" value="{{ old('tgl_berakhir') }}"
                        class="w-full px-4 py-3 border rounded-lg shadow-sm @error('tgl_berakhir') border-red-500 @enderror"
                        required>
                    @error('tgl_berakhir')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" name="jumlah_orang" id="jumlah_orang" placeholder="Contoh: 3"
                        ...
                        class="w-full px-4 py-3 border rounded-lg shadow-sm @error('jumlah_orang') border-red-500 @enderror"
                        min="1" required>
                    @error('jumlah_orang')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
