<x-mahasiswa-layout>
    <div class="space-y-6 p-6 md:p-10">
        ...
        <div class="bg-white p-6 md:p-10 rounded-xl shadow-lg border border-gray-100">
            ...
            <form method="POST" action="{{ route('mahasiswa.laporan.akhir.store') }}" class="space-y-8 max-w-xl mx-auto"
                enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="penempatan_id" value="{{ $penempatan->id_penempatan }}">
                <div>
                    <input type="text" name="judul" id="judul_laporan" placeholder="Judul Laporan Akhir"
                ...
                <div class="space-y-3">
                    <label for="file_laporan" class="block text-lg font-medium text-gray-700">Upload File
                        Laporan</label>
                    <div class="flex items-center space-x-4 border border-gray-300 rounded-lg shadow-sm bg-gray-50 p-3">
                        ...
                        <div class="flex items-center justify-between flex-1 min-w-0">
                            ...
                            <button type="button"
                                onclick="resetFile('file_laporan_akhir_input', 'filename_akhir', 'Belum ada file yang dipilih (.pdf, .docx)')"
                                class="text-red-500 hover:text-red-700 transition focus:outline-none p-1 rounded-full hover:bg-red-100"
                                title="Batalkan File">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <input type="file" name="file_laporan_akhir" id="file_laporan_akhir_input" accept=".pdf, .docx"
