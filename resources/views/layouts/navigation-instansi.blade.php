<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Menu Baru: Manajemen Konten -->
                    <x-nav-link :href="route('admin-instansi.manajemen-bidang.index')" :active="request()->routeIs('admin-instansi.manajemen-bidang.*')">
                        {{ __('Manajemen Bidang') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin-instansi.manajemen-bidang.index')" :active="request()->routeIs('admin-instansi.manajemen-bidang.*')">
                {{ __('Manajemen Bidang') }}
            </x-responsive-nav-link>
        </div>
